  ...
  <header class="header">
    ...
    <div class="options">
      <div class="options__home">
        <svg class="house-icon" viewBox="0 0 78 78">
          <path
